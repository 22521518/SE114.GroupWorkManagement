...
fun AddTaskLeaderRow(
    ...
    val list by remember { mutableStateOf(vm.leaders.value) }
    ...
    Row(
        ...
        OutlinedButton(
            onClick = {
                navController.navigate(Destination.GroupAddLeader.route)
            },
...
fun AddTaskMemberRow(
    ...
    val list by remember { mutableStateOf(vm.members.value) }
    ...
    Row(
        ...
        OutlinedButton(
            onClick = {
                navController.navigate(Destination.GroupAddMember.route)
            },
            modifier = Modifier.size(60.dp),
            shape = RoundedCornerShape(10.dp),
            border = BorderStroke(1.5.dp, fontColor)
...
fun AddInsiderMemberRow(
    ...
    Row(
        ...
        OutlinedButton(
            onClick = {
                navController.navigate(Destination.GroupAddInsider.route)
            },
            modifier = Modifier.size(60.dp),
            shape = RoundedCornerShape(10.dp),
            border = BorderStroke(1.5.dp, fontColor)
...
fun AddOutsiderMemberRow(
    ...
    val list by remember { mutableStateOf<List<AUser>>(listOf()) }
    ...
    Row(
        ...
        OutlinedButton(
            onClick = {
                navController.navigate(Destination.GroupAddOutsider.route)
            },
            modifier = Modifier.size(60.dp),
            shape = RoundedCornerShape(10.dp),
            border = BorderStroke(1.5.dp, fontColor)
